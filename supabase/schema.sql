...
create index songs_queue_idx on public.songs (is_active, created_at);
create index reviews_song_idx on public.reviews (song_id, created_at desc);
create index reviews_reviewer_idx on public.reviews (reviewer_id, created_at desc);
create index reviews_quality_idx on public.reviews (reviewer_id, quality_passed);
